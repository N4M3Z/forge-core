...
Move bulk reference material out of `SKILL.md` into companion files referenced with `@` includes. The SKILL.md stays the entrypoint an AI reads to decide behavior; companions load on demand. Follows [ARCH-0002](../../docs/decisions/ARCH-0002 Skills Companion Files.md).
...
| Decision tables with 3 to 7 rows                                         | No, inline                          |
