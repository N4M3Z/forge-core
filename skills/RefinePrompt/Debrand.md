...
Strip vendor and brand references so the skill generalizes across ecosystems.
...
- "Use Docker Scout" to "Use a vulnerability scanner" passes, debrand it.
- "Avoid Inter and Roboto" to "Avoid <font>s and <font>s" fails, keep the names because they ARE the content.
